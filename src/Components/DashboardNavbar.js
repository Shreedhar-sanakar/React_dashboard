                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="#">
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src="https://previews.123rf.com/images/pandavector/pandavector1607/pandavector160700160/60027009-boy-icon-flat-single-avatar-people-icon-from-the-big-avatar-collection-stock-vector.jpg"
                                            alt="..." style={{width:"80",height:"80"}} />
